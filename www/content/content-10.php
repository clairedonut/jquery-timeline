<section class="row content_10">

  <div class="col-12">
    <h2 class="">Le Château de La Mardelle</h2>

    <iframe src="https://www.google.com/maps/embed?pb=!1m28!1m12!1m3!1d10890.584795994568!2d1.2197992801993516!3d46.96864101635818!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m13!3e2!4m5!1s0x47fc835a0dd8e6ff%3A0xac73e3c3af649089!2sSemblancay%2C+Le+Tranger!3m2!1d46.963783899999996!2d1.2222849999999998!4m5!1s0x47fc834b29e666bb%3A0xa4e3b1f72ab374e1!2sLa+Mardelle%2C+36700+Le+Tranger!3m2!1d46.973510999999995!2d1.234558!5e0!3m2!1sen!2sfr!4v1520707959622" width="100%" height="250" frameborder="0" style="border:0" allowfullscreen></iframe>
  </div>

  <blockquote class="offset-2 col-8 py-4" cite="http://www.chateau-fort-manoir-chateau.eu/chateaux-indre-chateau-a-le-tranger-chateau-de-la-mardelle.html">
    Le premier seigneur connu est Jean Hérissard, seigneur de Vitray en 1535, marié
    à Antoinette de Maussabré, succède Jean Raoulx, puis au XVIIe siècle la famille
    de Thienne. En 1819, le château de la Mardelle appartient à Claude Pocquet,
    anobli par Louis XVIII en 1823. Ses descendants posséderont la demeure jusqu'en
    1980.
  </blockquote>
  ...
  <div class="offset-2 col-8">
    <h3 class="accordion">
      <i>
        C’était comment laboureur à La Mardelle en 1829 ?
      </i>
    </h3>
    <div class="collapse display none p-5">
      <blockquote cite="ttps://fr.wikipedia.org/wiki/Condition_paysanne_en_France_du_XIXe_au_XXIe_si%C3%A8cle#La_paysannerie_entre_l'Ancien_R%C3%A9gime_et_la_Restauration_(1789-1815)">

        <h3>La paysannerie entre l'Ancien Régime et la Restauration (1789-1815)</h3>
...
<!-- carouselExampleIndicators -->
  <section class="row bg-green" style="width:100%;">
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="carousel-item active">
            <img class="" src="img/articles/img-11.jpg" alt="First slide">
          </div>
          <div class="carousel-item">
            <img class="" src="img/articles/img-12.png" alt="Second slide">
          </div>
          <div class="carousel-item ">
            <img class="" src="img/articles/img-13.png" alt="Third slide">
          </div>
        </div>
